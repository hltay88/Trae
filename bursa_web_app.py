...
if not popup_mode:
    ...
    universe_options = {
        ...
        "Sector: Utilities (Large Cap)": "sector-utilities",
        "Sector: Infrastructure (Large Cap)": "sector-infra",
        "Sector: Property & REIT (Large Cap)": "sector-property",
        "Sector: Consumer (Large Cap)": "sector-consumer",
        "Sector: Banks & Financials (Large Cap)": "sector-banks",
        "Sector: Healthcare (Large Cap)": "sector-healthcare",
        "Sector: Energy (Oil & Gas) (Large Cap)": "sector-energy",
        "Sector: Plantation (Large Cap)": "sector-plantation",
        "Sector: Telco & Media (Large Cap)": "sector-telco",
        "Sector: Industrials (Large Cap)": "sector-industrial",
